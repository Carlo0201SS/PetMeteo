...
//import 'package:appmeteonew/UI/scenes/userScreen/ViewModel/components/humidity.dart';

class InfoContainerHumidity extends StatelessWidget {
  final String text1;
  final String text2;
  final IconData icon;
  final dynamic color;

  const InfoContainerHumidity({
    super.key,
    required this.text1,
    required this.text2,
    required this.icon,
