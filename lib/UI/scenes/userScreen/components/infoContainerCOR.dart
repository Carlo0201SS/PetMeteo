...
//import 'package:appmeteonew/UI/scenes/userScreen/ViewModel/components/chanceofrain.dart';

class InfoContainerCOR extends StatelessWidget {
  final String text1;
  final String text2;
  final IconData icon;
  final dynamic color;

  const InfoContainerCOR({
    super.key,
    required this.text1,
    required this.text2,
    required this.icon,
